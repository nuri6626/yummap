    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white px-4 py-6 mb-3">
        ...
        <div className="bg-orange-50 rounded-2xl p-4 mb-4">
          ...
          <div className="space-y-2">
            {[
              { label: '자극도', value: 7, left: '순한맛', right: '강한맛' },
              { label: '입맛 기준', value: 8, left: '관대한 입', right: '까다로운 입' },
              { label: '음식 스타일', value: 6, left: '전통/담백', right: '트렌디/퓨전' },
        ...
        <div className="bg-white border border-orange-100 rounded-2xl p-4">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-xs text-gray-400">
                다음 등급까지 {GRADE_INFO.nextScore - GRADE_INFO.currentScore}점
              </p>
            </div>
          ...
          <div className="bg-gray-100 rounded-full h-3 mb-2">
            <div
              ...
              style={{ width: `${GRADE_INFO.progress}%` }}
            />
          </div>
      ...
      <div className="flex-1 px-4 pb-20 max-w-md mx-auto w-full">
        ...
        {activeTab === 'collections' && (
          <div className="space-y-3">
            <button
              className="w-full bg-orange-500 text-white font-bold py-3 rounded-2xl mb-2"
            >
              + 새 컬렉션 만들기
            </button>
            {[
